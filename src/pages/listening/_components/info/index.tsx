      ...
      <div className="w-full">
        ...
        <div className="mb-6 mt-3">
          ...
          <div className="flex flex-col gap-1">
            <p>
              <strong>Part 1,4: Dịch kỹ câu hỏi, đáp án và đọc đi đọc lại để đi thi có nhận diện đáp án và khoanh theo.</strong> 
            </p>
            <p>
              <strong>Part 2,3: Nghe cẩn thận theo audio và chọn đáp án. Sau đó check đáp án và soát lại kỹ theo đoạn transcript.</strong>
            </p>
